...
class DummyInventoryRepo:
    ...
    def set_inventory_quantity_at_location(
        ...
        keys_to_remove = [
            k for k in self.inventory.keys()
            if k[0] == design_id and k[1] == color_id
        ]
...
def test_compute_loose_parts_reconciliation_items_no_mismatches():
    ...
    service._inventory.totals_by_location[("3001", 1)] = [
        {"drawer_id": 2, "drawer_name": "Drawer 2", "container_id": 2, "container_name": "Container 2", "quantity": 5}
    ]
...
def test_compute_loose_parts_reconciliation_items_with_mismatch():
    ...
    service._inventory.totals_by_location[("3001", 1)] = [
        {"drawer_id": 2, "drawer_name": "Drawer 2", "container_id": 2, "container_name": "Container 2", "quantity": 3}
    ]
...
def test_compute_loose_parts_reconciliation_items_excludes_put_away():
    ...
    service._inventory.totals_by_location[("3001", 1)] = [
        {"drawer_id": 2, "drawer_name": "Drawer 2", "container_id": 2, "container_name": "Container 2", "quantity": 3},
        {"drawer_id": 1, "drawer_name": "Put Away", "container_id": 1, "container_name": "Put Away", "quantity": 2}
    ]
...
def test_compute_teardown_reconciliation_items_with_mismatch():
    ...
    service._inventory.totals_by_location[("3001", 1)] = [
        {"drawer_id": 1, "drawer_name": "Put Away", "container_id": 1, "container_name": "Put Away", "quantity": 3}
    ]
...
def test_update_inventory_location_removes_old_location():
    ...
    service.update_inventory_location(
        "3001", 1, 5, drawer_id=3, container_id=3, is_teardown=False
    )
